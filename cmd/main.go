...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4023f0b0.vke.volcengine.com",
	...
	if err = (&controller.SidecarConfigReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SidecarConfig")
		os.Exit(1)
	}
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&serverlessv1alpha1.SidecarConfig{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SidecarConfig")
			os.Exit(1)
		}
		if err = ((&mywebhook.PodInjector{}).SetupWebhookWithManager(mgr)); err != nil {
